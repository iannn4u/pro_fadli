    ...
    <form class="max-w-sm" action="/user/{{ auth()->user()->id_user }}" method="post">
        ...
        <div class="mb-5">
            ...
            <input type="text" id="role" name="role"
                class="bg-gray-50 border-none text-gray-900/50 text-sm rounded-lg focus:none block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required value="{{ auth()->user()->role }}" readonly />
        </div>
        <div class="mb-5">
