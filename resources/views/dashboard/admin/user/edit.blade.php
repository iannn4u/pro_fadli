...
@section('main')
    ...
    <form class="max-w-sm" action="/user/edit/{{ $user->id_user }}" method="post">
        @csrf
        <div class="mb-5">
            <label for="name_user" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Fullname</label>
            <input type="text" id="name_user" name="name_user" value="{{ old('name_user', $user->name_user) }}" required
        ...
        <div class="mb-5">
            ...
            <input type="text" id="username_user" name="username_user"
                value="{{ old('username_user', $user->username_user) }}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required />
        </div>
        <div class="mb-5">
